...
const { roll, effect, multipleEffects, doDamage, useUpGear } = Procedure
	...
	* You have to take several shots, reducing your ammo by one.`,
	...
	procedure: new Procedure('When you take aim and shoot at an enemy at range', roll('roll+Dex', {
		...
		partialSuccess: multipleEffects(choice('Choose one', {
			'You have to move to get the shot, placing you in danger as described by the GM.': effect('You are in danger as described by the GM.'),
