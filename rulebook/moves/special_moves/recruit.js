...
const { roll, choice, modifier, noEffect, multipleEffects } = Procedure
...
* On a miss someone influential and ill-suited declares they’d like to come along (a foolhardy youth, a loose-cannon, or a veiled enemy, for example), bring them and take the consequences or turn them away. If you turn away applicants you take -1 forward to recruit.`,
	...
	procedure: new Procedure('When you put out word that you’re looking to hire help', multipleEffects(
			choice('Do you make it known that your pay is generous?', { 'Yes': modifier('+1', { forced: true, usages: 1 }), 'No': noEffect() }),
			choice('Do you make it known what you’re setting out to do?', { 'Yes': modifier('+1', { forced: true, usages: 1 }), 'No': noEffect() }),
			choice('Do you make it known that they’ll get a share of whatever you find?', { 'Yes': modifier('+1', { forced: true, usages: 1 }), 'No': noEffect() }),
			choice('Do you have a useful reputation around these parts?', { 'Yes': modifier('+1', { forced: true, usages: 1 }), 'No': noEffect() }),
			roll('roll', {
